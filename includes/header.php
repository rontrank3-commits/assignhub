...
<nav class="topbar">
  <a class="logo" href="/dashboard.php" style="padding:0 16px">
    <img id="topbarLogo" src="/assets/img/logo-dark.png" alt="PLT Solutions" style="height:36px;width:auto;object-fit:contain">
  </a>
  <div class="topbar-right">
    ...
    <a href="/logout.php" class="btn btn-ghost btn-sm" id="logoutBtn"><i class="ti ti-logout"></i></a>
  </div>
</nav>
...
<div class="sidebar">
  ...
  <a href="/assignments.php" class="nav-item <?= $currentPage==='assignments'?'active':'' ?>">
    <i class="ti ti-file-text"></i> Bài tập
  </a>
  <?php if (isStudent()): ?>
  <a href="/submit.php" class="nav-item <?= $currentPage==='submit'?'active':'' ?>">
  ...
  <?php endif; ?>
  <?php if (isTeacher()): ?>
  <a href="/grading.php" class="nav-item <?= $currentPage==='grading'?'active':'' ?>">
